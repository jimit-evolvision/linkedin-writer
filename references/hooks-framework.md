# Hook Framework for LinkedIn Posts

## The 3-Step Hook Formula

Every hook builds a **Curiosity Loop**: the gap between what the reader knows and what they need to know.

### Step 1: Context Lean-In (First 1-2 lines)

Two jobs simultaneously:
- **Topic Clarity**: What is this post about? Let the reader self-select in or out.
- **Lean-In Trigger**: Make them care. Use ONE of these:
  - Establish common ground (shared experience or belief)
  - Reference a benefit they want or a pain point they have
  - Use a metaphor to simplify something complex
  - State something so surprising it stuns them

Sentences should be staccato: short, compressed, maximum clarity per word.

### Step 2: Scroll Stop Interjection (Single line)

A stun gun. One line that freezes forward motion.
- Use a contrasting word: "But", "However", "Yet", "Although", "Except"
- Its only job: freeze the reader and set up the snapback
- This is a setup line, not the payoff

### Step 3: Contrarian Snapback (1-2 lines)

Snap the reader in the OPPOSITE direction of the initial lean-in.
- Must stay on topic but take an unexpected path
